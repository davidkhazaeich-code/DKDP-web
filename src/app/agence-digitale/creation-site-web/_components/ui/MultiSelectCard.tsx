    ...
    <button
      ...
      className={[
        ...
        selected
          ...
          : 'border border-border bg-[var(--surface-subtle)] hover:border-border-strong hover:bg-[var(--surface-default)]',
      ].join(' ')}
    >
      {/* Checkmark top-right */}
      <span
        className={[
          ...
          selected
            ...
            : 'bg-transparent border border-[color:var(--surface-border)] opacity-0 scale-75',
        ].join(' ')}
      >
        ...
        {icon && (
          <span
            className={[
              ...
              selected ? 'text-violet-400' : 'text-text-muted group-hover:text-text-secondary',
            ].join(' ')}
          >
            {icon}
          </span>
          ...
          <div className="flex items-baseline justify-between gap-2 flex-wrap">
            ...
            {price && (
              <span className={[
                ...
                selected ? 'text-violet-300' : 'text-text-secondary',
              ].join(' ')}>
                {price}
                {priceLabel && (
                  <span className="text-text-muted font-normal">{priceLabel}</span>
                )}
              </span>
            )}
          </div>
