  ...
  return (
    <div className="grid grid-cols-2 gap-3 w-full">
      ...
      <div className="p-4 rounded-[12px]" style={{ background: 'rgba(74,222,128,0.08)', border: '1px solid rgba(74,222,128,0.22)' }}>
        <p className="text-[10px] font-bold uppercase tracking-widest mb-4 text-center" style={{ color: '#4ade80' }}>Compte DKDP</p>
        <div className="space-y-2">
          {[
        ...
        <p className="text-[10px] text-center mt-2 font-semibold" style={{ color: '#4ade80' }}>Budget optimisé</p>
      </div>
    </div>
  )
}
