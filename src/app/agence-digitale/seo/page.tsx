...
function SEOFunnel() {
  ...
  return (
    <div className="space-y-3 w-full">
      <p className="text-[11px] font-bold uppercase tracking-widest mb-4 text-center" style={{ color }}>
      ...
      {positions.map((p) => (
        <div key={p.pos} className="space-y-1">
          <div className="flex justify-between items-center">
            ...
            <span className="font-bold text-sm" style={{ color: '#A78BFA' }}>{p.pct}% des clics</span>
          </div>
