    ...
    try {
      ...
      const res = await fetch('/api/contact', {
        ...
        body: JSON.stringify({
          ...
          service: 'AI Training',
          source: 'Landing page /en/corporate-training/ai',
          _gotcha: honeypot,
        }),
      })
    ...
    >
      ...
      <div className="p-8 md:p-10" style={{ background: OB }}>
        ...
        <h2 className="text-2xl md:text-3xl font-bold text-text mb-3 leading-tight">
          Get your tailored programme within 48h
        </h2>
        <p className="text-text-secondary text-sm leading-relaxed mb-7">
          Tell us what your team does and we will prepare a programme adapted to your
          real use cases: ChatGPT Astra, Claude, Copilot or all three.
        </p>

        <div className="space-y-3 mb-8">
          {[
            'Programme 100% adapted to your sector',
        ...
        >
          ...
          <p className="text-[12px] text-text-secondary leading-relaxed">
            ...
            If your team applies no skill from day one, we come back free of charge.
          </p>
        </div>
      ...
      <div className="p-8 md:p-10 bg-bg-card">
        {status === 'success' ? (
          <div className="flex flex-col items-center justify-center h-full text-center gap-5 py-8">
            ...
            <div>
              ...
              <p className="text-text-secondary text-sm leading-relaxed">
                We will reply within 48h with a personalised programme and a detailed quote.
              </p>
            </div>
          </div>
        ) : (
          <form onSubmit={handleSubmit} className="space-y-4 h-full flex flex-col justify-center">
            ...
            <p className="text-text-muted text-xs mb-4">Reply within 48 working hours.</p>
            ...
            <div>
              ...
              <textarea
                ...
                placeholder="Team size, sector, tools used..."
                rows={3}
            ...
            {status === 'error' && (
              <p className="text-xs" style={{ color: 'var(--red-text)' }}>
                Something went wrong. Contact us directly at{' '}
            ...
            <p className="text-[11px] text-text-muted text-center">
              Reply within 48h · No commitment · Confidential data
            </p>
          </form>
        )}
      </div>
