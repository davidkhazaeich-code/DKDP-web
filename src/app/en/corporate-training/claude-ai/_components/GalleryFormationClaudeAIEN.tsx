...
const IMAGES = [
  ...
  },
  {
    ...
    alt: 'Claude Projects training Geneva: team collaborating on a shared Claude space during a DKDP session',
    caption: 'Claude Projects team workshop',
  },
  {
  ...
  },
  {
    ...
    alt: 'Claude AI corporate training Geneva 2026: DKDP conference in front of a group of professionals',
    caption: 'DKDP plenary session',
  },
]

export function GalleryFormationClaudeAIEN() {
