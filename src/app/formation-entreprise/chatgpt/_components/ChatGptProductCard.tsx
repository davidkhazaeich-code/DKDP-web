...
/**
 * Carte produit de l'ecosysteme ChatGPT (Chat, Work, Codex, GPTs, Business,
 * Copilot). Meme gabarit que ClaudeProductCard sur la page Claude, pour que les
 * deux pages formation se lisent de la meme facon.
 */
export function ChatGptProductCard({
  title,
  subtitle,
  color,
  bg,
