...
export function LeadFormInlineClaudeAI() {
    ...
    try {
      const res = await fetch('/api/contact', {
        ...
        body: JSON.stringify({
          ...
          email: form.email,
          message: form.message || 'Demande de devis formation Claude IA (landing page)',
          service: 'Formation Claude IA',
          source: 'Landing page /formation-entreprise/claude-ai',
          _gotcha: honeypot,
        }),
      })
      ...
      if (res.ok) {
        ...
        trackLead({
          ...
          form_location: 'formation_claude_ai_landing',
    ...
    >
      ...
      <div className="p-8 md:p-10" style={{ background: CB }}>
        ...
        <p className="text-text-secondary text-sm leading-relaxed mb-7">
          Dites-nous la taille de votre équipe et vos cas d&apos;usage. On vous prépare un programme adapté :
          Claude.ai, Projects collaboratifs, Extended Thinking ou Claude Code.
        </p>
