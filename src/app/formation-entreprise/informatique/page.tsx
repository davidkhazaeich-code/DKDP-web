...
const FAQ = [
  ...
  },
  {
    ...
    answer:
      'Une demi-journée de formation informatique (jusqu\'à 8 personnes) est facturée à partir de CHF 700. Une journée complète se situe à CHF 1\'200 selon la personnalisation. Tarif forfaitaire par groupe.',
  },
]
        ...
        <div className="max-w-[1200px] mx-auto px-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            {[
              ...
              {
                label: 'Journée Autonomie',
                price: "CHF 1'200",
                duration: '6h · jusqu\'à 10 personnes',
                highlight: true,
                features: [
                  'Programme complet',
                  'Sécurité informatique incluse',
                  'Sauvegardes cloud (OneDrive)',
                  'Introduction outils collaboratifs',
                  'Attestation individuelle',
                  'Q&R 30 jours après',
                ],
                cta: 'Demander un devis',
              ...
              },
              {
                label: 'IT Complet',
                price: "CHF 2'000",
                duration: '2 x 3h · jusqu\'à 10 personnes',
                highlight: false,
                features: [
                  'Initiation + sécurité avancée',
                  'Introduction bureautique incluse',
                  'Dépannage de base guidé',
