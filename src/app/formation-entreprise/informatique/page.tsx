        ...
        <section className="pt-28 pb-24">
          <div className="max-w-[1200px] mx-auto px-6">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-16 items-start">
              <div>
                <h1 className="grad-tag inline-block text-xs md:text-sm mb-6">Formation informatique entreprise Genève & Suisse romande</h1>
                ...
                <HeroPills
                  ...
                  items={[
                    ...
                    { label: 'Vos propres outils', Icon: Monitor },
            ...
            >
              <div className="flex items-center gap-4">
                ...
                <div>
                  ...
                  <p className="text-text font-bold text-lg leading-tight">Formation Cybersécurité Entreprise</p>
