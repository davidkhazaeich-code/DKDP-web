  ...
  return [
    ...
    },
    {
      ...
      links: [
        ...
        { label: t.formationLinks[2], href: lp('/formation-entreprise/chatgpt') },
        { label: t.formationLinks[3], href: lp('/formation-entreprise/canva') },
        { label: t.formationLinks[4], href: lp('/formation-entreprise/figma') },
        { label: t.formationLinks[5], href: lp('/formation-entreprise/bureautique') },
        { label: t.formationLinks[6], href: lp('/formation-entreprise/cybersecurite') },
        { label: t.formationLinks[7], href: lp('/formation-entreprise/reseaux-sociaux') },
        { label: t.formationLinks[8], href: lp('/formation-entreprise/montage-video') },
        { label: t.formationLinks[9], href: lp('/formation-entreprise/informatique') },
        { label: t.formationLinks[10], href: lp('/formation-particuliers') },
      ],
