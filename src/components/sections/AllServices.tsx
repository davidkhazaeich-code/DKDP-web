...
const AGENCE_SERVICES: ServiceItem[] = [
  ...
  { icon: Smartphone, title: 'Développement d\'application', href: '/agence-digitale/développement-application', description: 'iOS, Android, web app et PWA sur mesure pour vos besoins métier.', badge: 'Nouveau', image: '/images/services/dkdp-développement-application-service.webp', pillar: 'agence' },
