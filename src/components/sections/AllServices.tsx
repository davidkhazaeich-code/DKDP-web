              ...
              {PILLARS.map((pillar, idx) => {
                ...
                return (
                  <button
                    ...
                    style={{
                      background: isActive ? `${pillar.color}18` : 'rgba(9,9,11,0.75)',
                    ...
                    onMouseEnter={(e) => {
                      ...
                      el.style.background = `rgba(9,9,11,0.65)`
                    ...
                    onMouseLeave={(e) => {
                      ...
                      el.style.background = 'rgba(9,9,11,0.75)'
  ...
  return (
    ...
    >
      <Link
        ...
        style={{ background: 'rgba(9,9,11,0.75)', borderColor: service.badge ? `${color}40` : border, boxShadow: service.badge ? `0 0 28px ${color}10` : undefined }}
      >
        {/* Image */}
