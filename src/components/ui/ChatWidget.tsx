...
const WELCOME_MESSAGE =
  'Bienvenue chez DKDP. Nous accompagnons les entreprises à se démarquer en ligne avec des sites modernes et bien référencés. Comment puis-je vous aider aujourd\u2019hui ?'
