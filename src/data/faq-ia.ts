export const FAQ_IA = [
  ...
  },
  {
    ...
    answer:
      "L'IA n'est pas conçue pour remplacer vos collaborateurs, mais pour leur faire gagner du temps sur les tâches répétitives. En pratique, nos clients économisent en moyenne 8 à 10 heures par semaine par personne sur des tâches comme la saisie de données, la rédaction de rapports ou le tri des emails. Vos équipes se concentrent sur ce qui crée vraiment de la valeur.",
  },
  {
  ...
  },
  {
    ...
    answer:
      "On mesure le ROI en trois dimensions : temps économisé par tâche, volume de traitement augmenté, et erreurs réduites. DKDP établit un baseline avant le déploiement et un suivi mensuel après. En moyenne, nos clients atteignent un ROI positif en moins de 3 mois sur leur investissement initial.",
  },
  {
