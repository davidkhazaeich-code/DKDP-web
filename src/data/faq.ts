...
export const FAQ_ITEMS = [
  ...
  },
  {
    ...
    answer:
      `La formation se facture à l'heure : ${chfHeure(PRIX.formationHourly1)} pour une personne, ${chfHeure(PRIX.formationHourly2)} pour deux, et sur devis pour un groupe de 3 à 10 personnes (demi-journée de 3 heures ou journée de 6 heures). La formation est 100% pratique, sur vos propres documents et outils. Nous proposons aussi des programmes sur mesure pour les grandes équipes. Devis gratuit sous 48h.`,
  },
  {
...
export const FAQ_ITEMS_EN = [
  ...
  },
  {
    ...
    answer:
      `Training is billed by the hour: ${chfHeure(PRIX.formationHourly1)} for one person, ${chfHeure(PRIX.formationHourly2)} for two, and on quote for a group of 3 to 10 people (half day of 3 hours or full day of 6 hours). The training is 100% hands-on, on your own documents and tools. We also offer custom programmes for larger teams. Free quote within 48h.`,
  },
  {
