...
export const CITIES: City[] = [
  {
    ...
    description: 'Agence digitale a Geneve : création de sites web, SEO, IA et formation pour les PME genevoises. Basee aux Eaux-Vives, a 5 minutes de Rive.',
    ...
    formationContext: 'Les équipes genevoises, souvent multilingues et dans des secteurs regulementes (finance, ONG, negoce), ont besoin de maîtriser l\'IA dans un cadre structure. Nos formations sur site a Geneve couvrent Claude AI, ChatGPT et l\'automatisation des workflows.',
  ...
  },
  {
    ...
    description: 'DKDP accompagne les entreprises de Lausanne en création de sites web, SEO, intelligence artificielle et formation. Agence basee a Geneve, interventions regulieres sur Lausanne.',
  ...
  },
  {
    ...
    description: 'Création de sites web, SEO et solutions IA pour les entreprises de Nyon et de la region de La Cote. Agence DKDP basee a Geneve.',
  ...
  },
  {
    ...
    description: 'DKDP cree des sites web, optimisé le SEO et déploie l\'IA pour les entreprises de Fribourg. Expertise Suisse romande depuis Geneve.',
  ...
  },
  {
    ...
    description: 'DKDP cree des sites web, optimisé le SEO et déploie l\'IA pour les entreprises de Neuchatel. Expertise en Suisse romande.',
